      ...
      <div class="section-popular-travel row justify-content-center">
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div
            ...
            style="background-image: url('frontend/images/popular-1@2x.png');"
          >
            <div class="travel-country">INDONESIA</div>
            <div class="travel-location">DERATAN, BALI</div>
            <div class="travel-button mt-auto">
              <a href="{{ route('detail') }}" class="btn btn-travel-details px-5">
                Hop In!
              </a>
            </div>
          </div>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div
            class="card-travel text-center d-flex flex-column"
            style="background-image: url('frontend/images/popular-2@2x.png');"
          >
            <div class="travel-country">INDONESIA</div>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div
            class="card-travel text-center d-flex flex-column"
            style="background-image: url('frontend/images/popular-3@2x.png');"
          >
            <div class="travel-country">NEPAL</div>
            <div class="travel-location">EVEREST, HIMALAYA</div>
            <div class="travel-button mt-auto">
              <a href="{{ route('detail') }}" class="btn btn-travel-details px-5">
                Hop In!
              </a>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div
            class="card-travel text-center d-flex flex-column"
            style="background-image: url('frontend/images/popular-4@2x.png');"
          >
            <div class="travel-country">UNITED STATES</div>
            <div class="travel-location">GOLDEN BRIDGE, SAN FRAN</div>
            <div class="travel-button mt-auto">
              <a href="{{ route('detail') }}" class="btn btn-travel-details px-5">
                Hop In!
              </a>
